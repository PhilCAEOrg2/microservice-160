...
public class ResTest {
  ...
  /**
   * 
   * Test for the NewTestCase_ID694812 method.
   * 
   */
  @Test
  public void testNewTestCase_ID694812() {
...
""", "text/plain", "*/*", new HashMap<>(), new Object[0]);
      System.out.println("Result of request with id: 247756: " + result.getResponse().trim());
    
      Assert.assertEquals("[878584]", 200, result.getHttpCode());
